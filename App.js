...
function isIphoneX() {
  return (
      ...
      !Platform.isPad &&
      !Platform.isTVOS &&
      windowSize.height === IPHONE_X_HEIGHT || windowSize.width === IPHONE_X_HEIGHT
      ||
      windowSize.height === IPHONE_XS_MAX_XR || windowSize.width === IPHONE_XS_MAX_XR
  );
}
...
const TopTabNavigator = createMaterialTopTabNavigator(
  ...
  },
  {
    ...
    tabBarOptions: {
      ...
      labelStyle: { fontSize: 10 }, //标签样式(可设置字体大小等)
      ...
      tabStyle: { backgroundColor: '#ffffff', height: 40 } //设置单个tabbar样式
    }
  }
);
